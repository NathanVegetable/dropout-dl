...
namespace dropout_dl {
	 ...
	 */
	std::string get_generic_page(const std::string& url, const std::string& referer = "https://watch.dropout.tv", long* response_status = nullptr, bool verbose = false, std::string* header_string = nullptr);
